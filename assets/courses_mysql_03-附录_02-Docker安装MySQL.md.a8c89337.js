import{_ as c}from"./chunks/ArticleMetadata.2a1f8ae6.js";import{_ as t,c as r,g as y,w as i,b as l,f as A,a as B,i as C,o as p,e as d,v as D}from"./app.439d55bc.js";const M=JSON.parse('{"title":"Docker 安装 MySQL 详细步骤","description":"","frontmatter":{"title":"Docker 安装 MySQL 详细步骤","author":"查尔斯","date":"2022/10/30 17:36","categories":["MySQL快速入门"],"tags":["MySQL","Docker","容器"],"showComment":false},"headers":[{"level":2,"title":"拉取镜像","slug":"拉取镜像","link":"#拉取镜像","children":[]},{"level":2,"title":"运行容器","slug":"运行容器","link":"#运行容器","children":[]},{"level":2,"title":"验证","slug":"验证","link":"#验证","children":[]},{"level":2,"title":"Docker Compose脚本","slug":"docker-compose脚本","link":"#docker-compose脚本","children":[]},{"level":2,"title":"附：安装MariaDB","slug":"附-安装mariadb","link":"#附-安装mariadb","children":[{"level":3,"title":"运行容器","slug":"运行容器-1","link":"#运行容器-1","children":[]},{"level":3,"title":"Docker Compose脚本","slug":"docker-compose脚本-1","link":"#docker-compose脚本-1","children":[]}]}],"relativePath":"courses/mysql/03-附录/02-Docker安装MySQL.md","lastUpdated":1669526061000}'),F={name:"courses/mysql/03-附录/02-Docker安装MySQL.md"},m=l("h1",{id:"docker-安装-mysql-详细步骤",tabindex:"-1"},[A("Docker 安装 MySQL 详细步骤 "),l("a",{class:"header-anchor",href:"#docker-安装-mysql-详细步骤","aria-hidden":"true"},"#")],-1),S=B(`<div class="tip custom-block"><p class="custom-block-title">笔者说</p><p>笔者下面的步骤及配置是基于指定版本的实践，大多数程序大多数情况下在相差不大的版本时可以直接参考。（当然了，即使是非 Docker 方式安装程序也是一样道理）</p></div><h2 id="拉取镜像" tabindex="-1">拉取镜像 <a class="header-anchor" href="#拉取镜像" aria-hidden="true">#</a></h2><div class="warning custom-block"><p class="custom-block-title">笔者说</p><p>拉取镜像时需要明确镜像版本（Tag）。</p></div><p>不指定版本（Tag）就拉取镜像，那拉取下来的镜像版本（Tag）默认是 <code>latest</code>（最新的）。<code>latest</code> 会跟随 Docker Registry 中的记录变化，现在拉取下来的 <code>latest</code> 是 x1 版本，但隔了一段时间后你在其他机器上再拉取 <code>latest</code> 可能就是 x2 版本了。</p><p>变化的版本，不利于生产环境部署的稳定。无论是后续在其他环境部署还是扩容集群等场景均要求根据架构要求指定好版本。</p><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#ABB2BF;">docker pull mysql:8.0.29</span></span>
<span class="line"></span></code></pre><pre class="shiki vp-code-light"><code><span class="line"><span style="color:#A6ACCD;">docker pull mysql:8.0.29</span></span>
<span class="line"></span></code></pre></div><h2 id="运行容器" tabindex="-1">运行容器 <a class="header-anchor" href="#运行容器" aria-hidden="true">#</a></h2><div class="warning custom-block"><p class="custom-block-title">笔者说</p><p><strong>下方的配置，切记要根据个人实际情况来修改。</strong></p></div><ul><li>容器的名称</li><li>镜像名称:版本</li><li>是否设置自启动？</li><li>环境变量配置</li><li>是否端口映射？</li><li>映射的话映射到宿主机哪个端口？</li><li>是否挂载卷？</li><li>挂载的话要挂载宿主机哪个目录？</li><li>......</li><li>等自定义配置</li></ul><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#7F848E;"># MYSQL_ROOT_PASSWORD：root 用户密码</span></span>
<span class="line"><span style="color:#7F848E;"># MYSQL_DATABASE：初始化数据库</span></span>
<span class="line"><span style="color:#7F848E;"># MYSQL_USER：初始化普通用户</span></span>
<span class="line"><span style="color:#7F848E;"># MYSQL_PASSWORD：初始化普通用户密码</span></span>
<span class="line"><span style="color:#ABB2BF;">docker run -d \\</span></span>
<span class="line"><span style="color:#ABB2BF;">--name mysql mysql:8.0.29 \\</span></span>
<span class="line"><span style="color:#ABB2BF;">--restart=always \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e TZ=Asia/Shanghai \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_ROOT_PASSWORD=123456 \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_DATABASE=test \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_USER=test \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_PASSWORD=123456 \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-p 3306:3306 \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-v /opt/disk/docker/volumes/mysql/conf:/etc/mysql/conf.d \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-v /opt/disk/docker/volumes/mysql/data:/var/lib/mysql \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-v /opt/disk/docker/volumes/mysql/logs:/logs \\</span></span>
...
<span class="line"></span></code></pre><pre class="shiki vp-code-light"><code><span class="line"><span style="color:#676E95;"># MYSQL_ROOT_PASSWORD：root 用户密码</span></span>
<span class="line"><span style="color:#676E95;"># MYSQL_DATABASE：初始化数据库</span></span>
<span class="line"><span style="color:#676E95;"># MYSQL_USER：初始化普通用户</span></span>
<span class="line"><span style="color:#676E95;"># MYSQL_PASSWORD：初始化普通用户密码</span></span>
<span class="line"><span style="color:#A6ACCD;">docker run -d \\</span></span>
<span class="line"><span style="color:#A6ACCD;">--name mysql mysql:8.0.29 \\</span></span>
...
<span class="line"><span style="color:#A6ACCD;">-e MYSQL_DATABASE=test \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-e MYSQL_USER=test \\</span></span>
...
<span class="line"><span style="color:#A6ACCD;">-v /opt/disk/docker/volumes/mysql/conf:/etc/mysql/conf.d \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-v /opt/disk/docker/volumes/mysql/data:/var/lib/mysql \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-v /opt/disk/docker/volumes/mysql/logs:/logs \\</span></span>
...
<span class="line"></span></code></pre></div><h2 id="附-安装mariadb" tabindex="-1">附：安装MariaDB <a class="header-anchor" href="#附-安装mariadb" aria-hidden="true">#</a></h2><h3 id="运行容器-1" tabindex="-1">运行容器 <a class="header-anchor" href="#运行容器-1" aria-hidden="true">#</a></h3><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#ABB2BF;">docker run -d \\</span></span>
<span class="line"><span style="color:#ABB2BF;">--name mariadb mariadb \\</span></span>
<span class="line"><span style="color:#ABB2BF;">--restart=always \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e TZ=Asia/Shanghai \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_ROOT_PASSWORD=123456 \\</span></span>
<span class="line"><span style="color:#ABB2BF;">-e MYSQL_DATABASE=test \\</span></span>
...
<span class="line"><span style="color:#ABB2BF;">-v /opt/disk/docker/volumes/mysql/data:/var/lib/mysql \\</span></span>
<span class="line"><span style="color:#ABB2BF;">--privileged=true</span></span>
<span class="line"></span></code></pre><pre class="shiki vp-code-light"><code><span class="line"><span style="color:#A6ACCD;">docker run -d \\</span></span>
<span class="line"><span style="color:#A6ACCD;">--name mariadb mariadb \\</span></span>
<span class="line"><span style="color:#A6ACCD;">--restart=always \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-e TZ=Asia/Shanghai \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-e MYSQL_ROOT_PASSWORD=123456 \\</span></span>
<span class="line"><span style="color:#A6ACCD;">-e MYSQL_DATABASE=test \\</span></span>
...
<span class="line"><span style="color:#A6ACCD;">-v /opt/disk/docker/volumes/mysql/data:/var/lib/mysql \\</span></span>
<span class="line"><span style="color:#A6ACCD;">--privileged=true</span></span>
<span class="line"></span></code></pre></div><h3 id="docker-compose脚本-1" tabindex="-1">Docker Compose脚本 <a class="header-anchor" href="#docker-compose脚本-1" aria-hidden="true">#</a></h3><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#E06C75;">version</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">&#39;3&#39;</span></span>
<span class="line"><span style="color:#E06C75;">services</span><span style="color:#ABB2BF;">:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/opt/disk/docker/volumes/mysql/data:/var/lib/mysql</span></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F07178;">privileged</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FF9CAC;">true</span></span>
<span class="line"></span></code></pre></div>`,22);function k(s,h,v,u,_,E){const o=c,e=C("ClientOnly");return p(),r("div",null,[m,y(e,null,{default:i(()=>{var a,n;return[(((a=s.$frontmatter)==null?void 0:a.aside)??!0)&&(((n=s.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),d(o,{key:0,article:s.$frontmatter},null,8,["article"])):D("",!0)]}),_:1}),S])}const b=t(F,[["render",k]]);export{M as __pageData,b as default};

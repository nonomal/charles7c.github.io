import{_ as t}from"./chunks/ArticleMetadata.b7f9de94.js";import{_ as c,c as r,g as i,w as d,b as l,f as A,a as y,i as C,o as p,e as D,v as F}from"./app.5e486581.js";const h="/assets/202208112010100.875fa5d2.png",x=JSON.parse('{"title":"执行Shell脚本，报java: command not found","description":"","frontmatter":{"title":"执行Shell脚本，报java: command not found","author":"查尔斯","date":"2022/08/11 20:19","categories":["Bug万象集"],"tags":["Linux","Shell"]},"headers":[{"level":2,"title":"问题描述","slug":"问题描述","link":"#问题描述","children":[]},{"level":2,"title":"原因分析","slug":"原因分析","link":"#原因分析","children":[]},{"level":2,"title":"解决方案1","slug":"解决方案1","link":"#解决方案1","children":[]},{"level":2,"title":"解决方案2","slug":"解决方案2","link":"#解决方案2","children":[]}],"relativePath":"categories/issues/2022/08/11/执行Shell脚本，报java command not found.md","lastUpdated":1667230305000}'),B={name:"categories/issues/2022/08/11/执行Shell脚本，报java command not found.md"},u=l("h1",{id:"执行shell脚本-报java-command-not-found",tabindex:"-1"},[A("执行Shell脚本，报java: command not found "),l("a",{class:"header-anchor",href:"#执行shell脚本-报java-command-not-found","aria-hidden":"true"},"#")],-1),v=y('<h2 id="问题描述" tabindex="-1">问题描述 <a class="header-anchor" href="#问题描述" aria-hidden="true">#</a></h2><p><strong>C：</strong> 今天笔者在公司的 dev 环境服务器上，将一个 Java 程序启动脚本做成了一个系统服务。本来是一件很简单的事情，但是在启动服务时，却报错了。</p><p>报的错误也是言简意赅：java: command not found。很直白的告诉了你，它找不到 java 命令。</p><p><img src="'+h+`" alt="202208112010100"></p><h2 id="原因分析" tabindex="-1">原因分析 <a class="header-anchor" href="#原因分析" aria-hidden="true">#</a></h2><p>既然是找不到 java 命令，首先要排查的自然是服务器里究竟有没有安装和配置好 Java 环境了，用 <code>java -version</code> 命令检测一下就可以了。</p><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#ABB2BF;">[root@business11 ~]</span><span style="color:#7F848E;"># java -version</span></span>
...
<span class="line"></span></code></pre></div>`,20);function m(s,_,E,b,g,k){const e=t,o=C("ClientOnly");return p(),r("div",null,[u,i(o,null,{default:d(()=>{var a,n;return[(((a=s.$frontmatter)==null?void 0:a.aside)??!0)&&(((n=s.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),D(e,{key:0,article:s.$frontmatter},null,8,["article"])):F("",!0)]}),_:1}),v])}const H=c(B,[["render",m]]);export{x as __pageData,H as default};

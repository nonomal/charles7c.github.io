...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,18);function E(s,g,m,v,S,b){const e=t,o=C("ClientOnly");return l(),c("div",null,[F,y(o,null,{default:i(()=>{var n,a;return[(((n=s.$frontmatter)==null?void 0:n.aside)??!0)&&(((a=s.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(l(),d(e,{key:0,article:s.$frontmatter},null,8,["article"])):u("",!0)]}),_:1}),h])}const _=r(B,[["render",E]]);export{O as __pageData,_ as default};

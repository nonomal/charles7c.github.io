...
<span class="line"></span></code></pre></div>`,20);function h(s,v,g,L,I,P){const o=c,e=D("ClientOnly");return p(),r("div",null,[k,i(e,null,{default:y(()=>{var a,n;return[(((a=s.$frontmatter)==null?void 0:a.aside)??!0)&&(((n=s.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),C(o,{key:0,article:s.$frontmatter},null,8,["article"])):B("",!0)]}),_:1}),E])}const S=t(m,[["render",h]]);export{O as __pageData,S as default};
